...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UVirtualCursorFunctionLibrary_DisableVirtualCursor_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVirtualCursorFunctionLibrary, nullptr, "DisableVirtualCursor", sizeof(VirtualCursorFunctionLibrary_eventDisableVirtualCursor_Parms), Z_Construct_UFunction_UVirtualCursorFunctionLibrary_DisableVirtualCursor_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UVirtualCursorFunctionLibrary_DisableVirtualCursor_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UVirtualCursorFunctionLibrary_DisableVirtualCursor_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UVirtualCursorFunctionLibrary_DisableVirtualCursor_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UVirtualCursorFunctionLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UVirtualCursorFunctionLibrary_DisableVirtualCursor, "DisableVirtualCursor" }, // 1138372040
		{ &Z_Construct_UFunction_UVirtualCursorFunctionLibrary_EnableVirtualCursor, "EnableVirtualCursor" }, // 460358162
		{ &Z_Construct_UFunction_UVirtualCursorFunctionLibrary_IsCursorOverInteractableWidget, "IsCursorOverInteractableWidget" }, // 410567553
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UVirtualCursorFunctionLibrary, 1826471016);
